...
public class AccountService {
    ...
    public void deleteAccount(Users user, Integer accountId) {
        Account account = accountRepositry.findAccountById(accountId);
        Users user1 = userRepositry.findUsersByUsername(user.getUsername());
    ...
    public void ActiveAccount(Users user, Integer accountId) {
        Account account = accountRepositry.findAccountById(accountId);
        Users user1 = userRepositry.findUsersByUsername(user.getUsername());
    ...
    public Account ViewDetails(Users user,Integer accountId){
           Account account = accountRepositry.findAccountById(accountId);
        Users user1 = userRepositry.findUsersByUsername(user.getUsername());
    ...
    public void deposit(Users user,Integer accountId,Integer amount){
           Account account = accountRepositry.findAccountById(accountId);
        Users user1 = userRepositry.findUsersByUsername(user.getUsername());
        if(account.getCustomer().getId()==user1.getCustomer().getId()){
        ...
        public void withdraw(Users user,Integer accountId,Integer amount){
           Account account = accountRepositry.findAccountById(accountId);
        Users user1 = userRepositry.findUsersByUsername(user.getUsername());
        if(account.getCustomer().getId()==user1.getCustomer().getId()){
            account.setBalance(account.getBalance()-amount);
    ...
    public void blockAccount(Users user, Integer accountId){
           Account account = accountRepositry.findAccountById(accountId);
        Users user1 = userRepositry.findUsersByUsername(user.getUsername());
        if (user1.getRole().equals("ADMIN")) {
    ...
    public void transTo(Integer fromAcountId,Integer toAccountID ,Users users ,Integer amount ){
         Users user1 = userRepositry.findUsersByUsername(users.getUsername());
